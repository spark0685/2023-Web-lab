...
data = Dataset.load_from_file('./recommend/rating_movie.csv', reader=reader)
...
with open ('./recommend/user_movie.csv', newline='', encoding='utf-8-sig') as csvfile:
...
with open('./recommend/svd_predict_movie.csv', 'w', newline='', encoding='utf-8-sig') as f:
