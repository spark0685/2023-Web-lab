...
# delete_line=[]
# head_count=Graph_2jump["head_entity"].value_counts()
# tail_count=Graph_2jump["tail_entity"].value_counts()
# relation_count=Graph_2jump["relation"].value_counts()


# line_index=0
# for head_entity in Graph_2jump["head_entity"]: 
#     if head_entity in head_count:
#         head_num=head_count[head_entity]
#     else:
#         head_num=0
...
# line_index = 0
# for tail_entity in Graph_2jump["tail_entity"]: 
#     if tail_entity in head_count:
#         head_num=head_count[tail_entity]
#     else:
#         head_num=0
...
# line_index=0
# for relation in Graph_2jump["relation"]: 
#     total_num=relation_count[relation]
#     if(total_num<50):
#         if(line_index not in delete_line):
#             delete_line.append(line_index)
...
# Graph_2jump.drop(index=delete_line,inplace=True,axis=0)
# Graph_2jump.reset_index(drop=True, inplace=True)
# print(len(Graph_2jump))
